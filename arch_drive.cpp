...
void screw_drive(){
	if (PS4.connected())
	{
		...
		left_power = map(leftjoystick_reading, 0, 314, 0, 127); //Maps analog output of joystick to ForwardsBackwards
		right_power = map(rightjoystick_reading, 0, 314, 0, 127); //Maps analog output to ForwardsBackwards levels
